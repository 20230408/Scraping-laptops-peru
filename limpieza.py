...
df = pd.read_csv("laptops_supermercados.csv")
...
excluir = ["funda", "maletín", "mochila", "accesorio", "fisher-price", "soporte", "cooler", "estuche", "adaptador", "base"]
...
df_filtrado.to_csv("laptops_limpio.csv", index=False)

print(f"✅ Limpieza completa: {len(df) - len(df_filtrado)} productos eliminados.")
print("📁 Guardado en: laptops_limpio.csv")
